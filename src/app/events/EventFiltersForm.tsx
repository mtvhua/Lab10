...
import { useRouter, usePathname } from 'next/navigation'; //para el lab
...
export function EventFiltersForm({ currentFilters }: EventFiltersFormProps): React.ReactElement {
  ...
  const router = useRouter(); // para el lab
  ...
  // Challenge Lab: Verificación de filtros activos para mostrar botón "Limpiar"
  ...
  return (
    <div className="space-y-4 rounded-lg border bg-card p-4">
      {/* Formulario con method GET - Sincroniza automáticamente con searchParams en el servidor */}
